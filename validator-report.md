...
Source commit: c2f144366744ca5bd4e62911a2819d4bd8cc982c
Source fix commits: c2f144366744ca5bd4e62911a2819d4bd8cc982c
...
| Testcase ID | Operation area | Phase 3 status |
| --- | --- | --- |
| `usage-ruby-vips-r16-text-hello-image-has-positive-width` | `text` operation dispatch and one-band non-trivial alpha-mask output | `passed` |
...
- Added safe `text` operation handling in `safe/src/ops/create.rs` for non-empty text, optional `dpi`, `font`, `width`, `height`, `spacing`, and `rgba`, producing `UCHAR` `B_W` alpha masks by default.
...
- Added `safe/tests/ops_core.rs` coverage through the exported `vips_text` C ABI path, checking positive dimensions, one band, `UCHAR` format, `B_W` interpretation, alpha min/max/mean, and PNG write magic.

Changed files in source fix commit: `safe/src/generated/operations.json`, `safe/src/generated/operations_registry.rs`, `safe/src/ops/create.rs`, `safe/src/ops/mod.rs`, and `safe/tests/ops_core.rs`.
...
- Lock path: `validator/artifacts/libvips-safe-ops-port-lock.json`
- Override root: `validator-overrides/libvips/`
- Release tag: `build-c2f144366744`
- Tag ref: `refs/tags/build-c2f144366744`
- Canonical validator package set: `libvips42t64`, `libvips-dev`, `libvips-tools`, `gir1.2-vips-8.0`
- Unported original packages: `[]`

| Package | Size | SHA256 | Filename |
| --- | ---: | --- | --- |
| `libvips42t64` | 1437514 | `1661d6b1f47fbc5ac704eb08da97ea237d701a91d663cd2e6e9e009511c44ad4` | `libvips42t64_8.15.1-1.1build4+safelibs1778736281_amd64.deb` |
| `libvips-dev` | 83404 | `b011a4ae818ec09d9c4d25d9d24b615e6accbf3ba38242184784bb4258429df5` | `libvips-dev_8.15.1-1.1build4+safelibs1778736281_amd64.deb` |
| `libvips-tools` | 27936 | `d8c0fd6866e59a0df3405111500b48a4872772b687961b7ced19de7a53232cd9` | `libvips-tools_8.15.1-1.1build4+safelibs1778736281_amd64.deb` |
| `gir1.2-vips-8.0` | 5194 | `4eb7b66f5d8cd8195ec83069511597f369d7bce89b3a3216b861c5699917f987` | `gir1.2-vips-8.0_8.15.1-1.1build4+safelibs1778736281_amd64.deb` |
